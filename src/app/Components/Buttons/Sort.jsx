...
const SortBtn = ({ onClick, options, sortBy, isSortOpen = false, show = false, setShow }) => {
    ...
    return (
        ...
        >
            <p className="items-center text-xs flex items-center ">
                <LuChevronsUpDown className="w-4 h-4 text-[#959595]" />
                <span className="ml-2 text-[#959595] font-medium">Sort By</span>
            </p>
            <div
                className={`
